...
* 特に指定がない限り、教科書で用いているPytorchを利用してコーディングしてください

### Q.1 ImageNetデータセット
* ImageNetデータセットについて説明してください（クラス数・訓練データ数・ベンチマークなど）

### Q.2 パッケージのimportとPytorchのバージョン確認
* この課題で利用するパッケージをimportしてください（知らなかったパッケージなどがあれば説明してください）
