...
* 線形回帰について説明してください（式・式中の何を学習するのか・どのような方法を使って学習するのかなど）
...
## Q.7 Pytorchによるディープラーニング実装の流れ（p.14~)
...
* 誤差逆伝播と最適化手法について説明してください（2つの関係性・最適化手法の計算式・最適化手法の種類など）
* ネットワークモデルの重みの初期値は，どのような値であるか説明してください
* 過学習とは何かを説明してください
