...
### Q.1 音データを再生してみよう（ノック71）
* "音声.mp3"と"携帯電話着信音.mp3"を再生してください
* vscode+jupyter環境では音源を再生できないので注意してください

### Q.2 音データを読み込んでみよう（ノック72）
* librosaを用いて"音声.mp3"と"携帯電話着信音.mp3"を読み込んでください
* 音源ファイルのサンプリングレートを確認してください
* ロードした音源を配列に格納し、shape/max/minを確認してください

### Q.3 音データの一部を取得してみよう（ノック73）
* "音声.mp3"と"携帯電話着信音.mp3"を1秒のデータに変換してください
* 編集したファイルを再生してみましょう

### Q.4 音データのサンプリングレートを変えてみよう（ノック74）
* サンプリングレートとは何かを説明してください
* サンプリングレートを22050Hzにして"音声.mp3"と"携帯電話着信音.mp3"を読み込んでみましょう
* サンプリングレートを8000Hzも試してみましょう
* サンプリングレートを変更したら，配列の形状が
* librosa.get_samplerateでサンプリングレートを確認してみましょう

### Q.5 音データを可視化してみよう（ノック75）
* "音声.mp3"の音源波形を可視化してみましょう（44100/22050/8000Hzそれぞれ可視化してください）
* "携帯電話着信音.mp3"の音源波形を確認してみましょう（44100HzのみでOK）

### Q.6 音データの大きさを取得してみよう（ノック76）
* RMSとは何かを説明してください
* "音声.mp3"と"携帯電話着信音.mp3"のデータ全体に対してのRMSを計算してください
* "音声.mp3"の時間別のRMSを算出してください
* "音声.mp3"のRMSデータを可視化してください

### Q.7 音データを保存しよう（ノック80）
* WAV形式で音データを保存してください
...
### Q.8 WAVデータを変換してみよう
* wavデータを読み込んでください
* flacおよびmp3で音源ファイルを保存（出力してください）
* wav/flac/mp3のデータの圧縮率を確認してください
* 圧縮率に違いがあれば，その理由を考察してください

### Q.9 周波数スペクトルを表示してみよう（ノック77）

### Q.10 スペクトログラムを可視化してみよう（ノック78）

### Q.11 音の高さや長さを変えてみよう（ノック79）
